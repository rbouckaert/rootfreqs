...
public class ThreadedTreeLikelihoodWithError extends GenericTreeLikelihood {
    ...
    final private Input<List<TreeLikelihoodWithError>> likelihoodsInput = new Input<>("*","",new ArrayList<>());
    ...
    /** calculation engine **/
    private TreeLikelihoodWithError [] treelikelihood;
    ...
    public void initAndValidate() {
        ...
        treelikelihood = new TreeLikelihoodWithError[threadCount];
        ...
        if (threadCount <= 1) {
            treelikelihood[0] = new TreeLikelihoodWithError();
            ...
            for (int i = 0; i < threadCount; i++) {
                ...
                treelikelihood[i] = new TreeLikelihoodWithError();
                ...
                likelihoodCallers.add(new ThreadedTreeLikelihoodWithError.TreeLikelihoodCaller(treelikelihood[i], i));
            }
        }
    }
    ...
    class TreeLikelihoodCaller implements Callable<Double> {
        private final TreeLikelihoodWithError likelihood;
        private final int threadNr;

        public TreeLikelihoodCaller(TreeLikelihoodWithError likelihood, int threadNr) {
    ...
    public double [] getPatternLogLikelihoods() {
        ...
        int i = 0;
        for (TreeLikelihoodWithError b : treelikelihood) {
